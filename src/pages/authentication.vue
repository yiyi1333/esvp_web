...
export default {
    ...
    methods: {
        onSubmit() {
            ...
            // console.log('store: ' + this.$store.state.userInfo.id)
            api.authentication(this.$store.state.userInfo.id, this.account.realname, this.account.idcard, this.account.phone, this.account.sex, this.account.birthday).then(res => {
                console.log(res)
